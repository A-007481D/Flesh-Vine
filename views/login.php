...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center bg-[url('../img/loginback.jpg')] backdrop-blur bg-cover bg-fixed"> 
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-5xl w-full flex overflow-hidden">
      <div class="w-1/2 relative">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center text-center text-white px-6">
          <div>
            <a href="home.php"><h1 class="text-4xl font-bold mb-2 font-merienda">Flesh & Vine</h1></a>
      ...
      <div class="w-1/2 p-8 flex flex-col justify-center">
        <h2 class="text-3xl font-bold text-[#cca45e] text-center">Log in</h2>
        <p class="text-gray-500 text-center mb-6">Log in to your account</p>
        ...
        <button type="submit" class="w-full bg-[#cca45e] text-white py-3 rounded-lg font-semibold hover:bg-[#cca45e]">Log in</button>

        <p class="text-center text-gray-500 mt-6">Don't have an account? <a href="register.php" class="text-[#cca45e] font-semibold hover:underline hover:text-blue-500">Register</a></p>
      </div>
    </div>
  </form>
</body>
